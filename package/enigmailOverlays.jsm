...
const overlays = {
  ...
  "chrome://messenger/content/messenger.xul": [
    "columnOverlay.xul", {
      ...
      application: "! postbox@postbox-inc.com {92650c4d-4b8e-4d2a-b7eb-24ecf4f6b63a}"
    }, {
      // Overlay for Postbox
    ...
    {
      url: "enigmailMessengerOverlay.xul",
      application: "!{92650c4d-4b8e-4d2a-b7eb-24ecf4f6b63a}"
    },
  ...
  "chrome://messenger/content/messageWindow.xul": [{
      // Overlay for Thunderbird (Interlink / Epyrus)
      url: "messengerOverlay-tbird.xul",
      application: "! postbox@postbox-inc.com {92650c4d-4b8e-4d2a-b7eb-24ecf4f6b63a}"
    }, {
      // Overlay for Postbox
...
var WindowListener = {
  ...
  onOpenWindow: function(xulWindow) {
    ...
    domWindow.addEventListener("load", function listener() {
      ...
      if (EnigmailCompat.isInterlink() || EnigmailCompat.isEpyrus()) {
