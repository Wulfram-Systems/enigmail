...
test(function testGetStrippedKey() {
  ...
  Assert.equal(got.substr(-127), "uJJFdXhmEyEa2eEcRioc/3zaAHGThE+8SnsA8IuuqALT43w3b14LizcmRWQcBnH5+PlhXYf3/nAlEnXD6TCZrOGlNCzLTWQTBLg1kw97xS/PQyCg24XsnHSt1DRJA==");
  Assert.equal(got.length, 3020);
});
