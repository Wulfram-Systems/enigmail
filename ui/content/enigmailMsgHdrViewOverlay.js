...
Enigmail.hdrView = {
  ...
  hdrViewLoad: function() {
    ...
    // Thunderbird/Interlink/Epyrus
    let attCtx = document.getElementById("attachmentItemContext");
    if (!attCtx) {
      // SeaMonkey
      attCtx = document.getElementById("attachmentListContext");
    }
  ...
  getSelectedAttachment: function() {
    ...
    else if (EnigmailCompat.isSeaMonkey()) {
      contextMenu = document.getElementById('attachmentListContext');
      let selectedItems = document.getElementById('attachmentList').selectedItems;
      selectedAttachments = [];
      for (let attElem of selectedItems) {
        selectedAttachments.push(attElem.attachment);
      }
    }
    else {
      // Thunderbird
  ...
  onShowAttachmentContextMenu: function(event) {
    ...
    if (EnigmailCompat.isSeaMonkey()) {
      suffix = "_SM";
    }

    var decryptOpenMenu = document.getElementById('enigmail_ctxDecryptOpen' + suffix);
    var decryptSaveMenu = document.getElementById('enigmail_ctxDecryptSave' + suffix);
    var importMenu = document.getElementById('enigmail_ctxImportKey' + suffix);
    var verifyMenu = document.getElementById('enigmail_ctxVerifyAtt' + suffix);
